...
public final class CacheConstants {
    ...
    /**
     * 字典项缓存前缀（翻译时通用 + 租户合并，同 value 租户覆盖通用）：
     * <ul>
     *   <li>通用字典：{@code system:core:dict:{typeCode}} -> List&lt;Option&gt;</li>
     *   <li>租户自定义字典：{@code system:core:dict:{typeCode}:{tenantId}} -> List&lt;Option&gt;</li>
     * </ul>
     */
